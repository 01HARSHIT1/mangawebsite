...
import { FaRobot, FaBrain, FaStar, FaEye, FaHeart, FaSync, FaChartLine, FaMagic } from 'react-icons/fa';
...
export default function AIRecommendations({
    ...
    const getCategoryIcon = (category: string) => {
        switch (category) {
            case 'trending': return <FaChartLine className="text-orange-400" />;
            ...
            case 'new-release': return <FaMagic className="text-green-400" />;
    ...
    if (loading) {
        return (
            <div className="space-y-4">
                ...
                <div className={`grid gap-6 ${variant === 'grid' ? 'grid-cols-1 sm:grid-cols-2 lg:grid-cols-3' : 'grid-cols-1'
                    }`}>
                    {[...Array(limit)].map((_, i) => (
    ...
    return (
        <div className="space-y-6">
            ...
            <div className={`grid gap-6 ${variant === 'grid' ? 'grid-cols-1 sm:grid-cols-2 lg:grid-cols-3' :
