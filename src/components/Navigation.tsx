                        ...
                        <div className="hidden md:ml-8 md:flex md:space-x-2">
                            ...
                            {isAuthenticated && (
                                <>
                                    <Link
                                        href="/library"
                                        className="group relative px-4 py-2 text-gray-300 hover:text-white rounded-lg text-sm font-semibold transition-all duration-300 hover:bg-green-500/20"
                                    >
                                    ...
                                    <Link
                                        href="/stats"
                                        className="group relative px-4 py-2 text-gray-300 hover:text-white rounded-lg text-sm font-semibold transition-all duration-300 hover:bg-indigo-500/20"
                                    >
