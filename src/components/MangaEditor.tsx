...
import { FaSave, FaUndo, FaRedo, FaImage, FaFont, FaSquare, FaCircle, FaPen, FaEraser, FaEye, FaDownload, FaUsers, FaComments } from 'react-icons/fa';
...
export default function MangaEditor({
    ...
    const tools = [
        ...
        { type: 'text', icon: FaFont, name: 'Text' },
                            ...
                            <div className="grid grid-cols-2 gap-2">
                                {tools.map((tool) => (
                                    <button
                                        ...
                                        className={`flex items-center space-x-2 p-3 rounded-lg transition-all duration-300 ${currentTool.type === tool.type
                            ...
                            <div className="flex justify-between mt-2">
                                {brushSizes.map((size) => (
                                    <button
                                        ...
                                        className={`w-8 h-8 rounded-full border-2 flex items-center justify-center transition-all duration-300 ${currentTool.size === size
                            ...
                            <div className="grid grid-cols-4 gap-2 mb-3">
                                {colors.map((color) => (
                                    <button
                                        ...
                                        className={`w-10 h-10 rounded-lg border-2 transition-all duration-300 ${currentTool.color === color
                ...
                <div className="bg-slate-800 border-b border-purple-500/20 p-4 flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-2">
                        ...
                        <button
                            ...
                            className={`p-2 rounded-lg transition-colors ${showLayers ? 'bg-purple-600 text-white' : 'bg-slate-700 text-gray-300 hover:bg-slate-600'
                                }`}
                            title="Toggle Layers"
                        >
                            <FaEye />
                        ...
                        <button
                            ...
                            className={`p-2 rounded-lg transition-colors ${showComments ? 'bg-purple-600 text-white' : 'bg-slate-700 text-gray-300 hover:bg-slate-600'
                                }`}
                            ...
                            <div className="mb-6">
                                ...
                                <div className="space-y-2">
                                    {layers.map((layer) => (
                                        <div
                                            key={layer.id}
                                            className={`p-3 rounded-lg border transition-all duration-300 cursor-pointer ${activeLayer === layer.id
