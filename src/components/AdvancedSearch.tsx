...
const GENRES = [
  'Action', 'Adventure', 'Comedy', 'Drama', 'Fantasy', 'Horror', 'Mystery', 'Romance', 'Sci-Fi', 'Slice of Life', 'Sports', 'Supernatural', 'Thriller', 'Psychological', 'Historical', 'Martial Arts', 'Mecha', 'Music', 'School Life', 'Shoujo', 'Shounen', 'Seinen', 'Josei', 'Ecchi', 'Harem', 'Isekai', 'Yaoi', 'Yuri'
];
...
export default function AdvancedSearch({ onSearch, initialFilters }: AdvancedSearchProps) {
  ...
  const performSearch = useCallback(async (searchFilters: SearchFilters) => {
    ...
    try {
      ...
      if (searchFilters.rating) params.set('rating', String(searchFilters.rating));
      ...
      const list: Manga[] = Array.isArray(data?.results) ? data.results : [];
      setResults(list);
      onSearch?.(list, searchFilters);
    } catch (e) {
