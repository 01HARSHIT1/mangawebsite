                            ...
                            <div className="mt-4 px-4">
                                <div className="flex items-center gap-3 flex-wrap">
                                    ...
                                    <button
                                        ...
                                        className={`px-4 py-2 rounded text-sm transition-colors ${userPreferences.autoNext
                                    ...
                                    <button
                                        ...
                                        className={`px-4 py-2 rounded text-sm transition-colors ${userPreferences.autoPlay
                                                ? 'bg-orange-600 hover:bg-orange-700'
                                                : 'bg-gray-800 hover:bg-gray-700'
                                            }`}
                                    >
                                    ...
                                    <button
                                        ...
                                        className={`px-4 py-2 rounded text-sm transition-colors ${userPreferences.autoSkip
                                                ? 'bg-orange-600 hover:bg-orange-700'
                                                : 'bg-gray-800 hover:bg-gray-700'
                                            }`}
                                    >
                                    ...
                                    <button
                                        ...
                                        className={`px-4 py-2 rounded text-sm transition-colors flex items-center gap-2 ${isNotificationSubscribed
                                            ...
                                            <div className="absolute top-full left-0 mt-2 bg-gray-900 rounded-lg shadow-xl p-2 min-w-[150px] z-50 border border-gray-700">
                                                {availableAudioTracks.map((audio: any) => (
                                                    <button
                                                        ...
                                                        className={`w-full text-left px-3 py-2 text-sm rounded hover:bg-gray-800 transition-colors ${selectedAudioTrack?.languageCode === audio.languageCode
                                            ...
                                            <div className="absolute top-full left-0 mt-2 bg-gray-900 rounded-lg shadow-xl p-2 min-w-[150px] z-50 border border-gray-700">
                                                ...
                                                {availableSubtitles.map((sub: any) => (
                                                    <button
                                                        ...
                                                        className={`w-full text-left px-3 py-2 text-sm rounded hover:bg-gray-800 transition-colors ${selectedSubtitle?.languageCode === sub.languageCode
                                                                ? 'bg-orange-600/20 text-orange-400 font-semibold'
                                                                : 'text-white'
                                                            }`}
                                                    >
                                ...
                                <div className="flex-1">
                                    ...
                                    {series.ageRating && (
                                        <div className="mb-4 flex items-center gap-3">
                                            <span className={`px-3 py-1 rounded-full text-sm font-semibold ${series.ageRating === 'G' ? 'bg-green-900/50 text-green-300 border border-green-500/30' :
                                    ...
                                    <div className="bg-gray-800/50 rounded-lg p-4">
                                        ...
                                        <div className="flex items-center gap-1 mb-2">
                                            {[1, 2, 3, 4, 5].map((star) => (
                                                <Star
                                                    key={star}
                                                    className={`w-5 h-5 cursor-pointer transition-colors ${star <= userRating
                                    ...
                                    filteredEpisodes.map((episode) => (
                                        <div key={episode._id} className="relative group">
                                            <button
                                                ...
                                                className={`w-full aspect-square rounded text-sm font-semibold transition-all relative overflow-hidden ${selectedEpisode === episode.episodeNumber
                ...
                <div className="max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    <div className="text-center mb-4">
                        <p className="text-gray-400 text-sm mb-2">
                            Copyright © RealmVerse. All Rights Reserved
                        </p>
                    ...
                    <div className="text-center">
                        <p className="text-gray-500 text-xs">
                            RealmVerse, watch anime, anime streaming
                        </p>
                    </div>
                </div>
            </footer>
