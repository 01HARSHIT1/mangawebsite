...
import { FaQrcode, FaSpinner, FaCheckCircle, FaTimes, FaClock, FaCopy, FaExternalLinkAlt } from 'react-icons/fa';
import QRCode from 'qrcode';
import { generateUPIPaymentUrl, UPI_CONFIG } from '@/lib/upi-config';

interface ImprovedUPIQRPaymentProps {
...
export default function ImprovedUPIQRPayment({ amount, description, onSuccess, onError, metadata }: ImprovedUPIQRPaymentProps) {
        ...
        <div className="w-full">
            ...
            {status === 'generating' && (
                <div className="w-full bg-blue-500/20 border border-blue-500/50 rounded-lg p-6 text-center">
                    ...
                    <p className="text-blue-200 text-sm mt-2">Creating payment link for {UPI_CONFIG.PERSONAL_UPI_ID}</p>
                </div>
            )}
                    ...
                    <div className="text-center mb-4">
                        ...
                        <div className="mb-4">
                            <div className="inline-flex items-center px-3 py-1 rounded-full bg-green-500/20 text-green-300 text-sm">
                                ...
                                UPI ID: {UPI_CONFIG.PERSONAL_UPI_ID}
                            </div>
                        </div>
